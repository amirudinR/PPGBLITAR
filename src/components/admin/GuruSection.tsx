...
import { Guru, GURU_STATUS_LIST } from '@/types/admin';
...
const initialData: Guru[] = [
  { id: '1', name: 'Budi Hartono', status: 'MT', phone: '081234567890' },
  { id: '2', name: 'Siti Aminah', status: 'MS', phone: '081234567891' },
  { id: '3', name: 'Ahmad Fauzi', status: 'Asisten Pengajar', phone: '081234567892' },
];
...
export default function GuruSection() {
  ...
  const openDialog = (item?: Guru) => {
    if (item) {
      ...
      setIsEditMode(false);
      setCurrentItem({ name: '', status: 'MT', phone: '' });
      setEditingId(null);
    }

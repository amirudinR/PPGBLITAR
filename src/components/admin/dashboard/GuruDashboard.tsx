  ...
  return (
    <div className="space-y-6">
      <div className="hero-gradient rounded-xl p-6 shadow-lg">
        ...
        <p className="text-[hsl(var(--hero-muted))]">Selamat datang di dasbor Anda sebagai Guru.</p>
      </div>
      
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="bg-[hsl(var(--stat-1)/0.1)] border-[hsl(var(--stat-1)/0.3)]">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-[hsl(var(--stat-1))]">Kehadiran Bulan Ini</CardTitle>
            <Calendar className="h-4 w-4 text-[hsl(var(--stat-1))]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[hsl(var(--stat-1))]">{overallStats.overallAttendanceRate}%</div>
            <Progress value={overallStats.overallAttendanceRate} className="mt-2" />
          </CardContent>
        </Card>
        
        <Card className="bg-[hsl(var(--stat-3)/0.1)] border-[hsl(var(--stat-3)/0.3)]">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-[hsl(var(--stat-3))]">Pencapaian Materi</CardTitle>
            <TrendingUp className="h-4 w-4 text-[hsl(var(--stat-3))]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[hsl(var(--stat-3))]">{overallStats.overallAchievementRate}%</div>
            <Progress value={overallStats.overallAchievementRate} className="mt-2" />
          </CardContent>
        </Card>
        
        <Card className="bg-[hsl(var(--stat-4)/0.1)] border-[hsl(var(--stat-4)/0.3)]">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-[hsl(var(--stat-4))]">Total Kelas</CardTitle>
            <School className="h-4 w-4 text-[hsl(var(--stat-4))]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[hsl(var(--stat-4))]">{kelas.length}</div>
            <p className="text-xs text-[hsl(var(--stat-4)/0.7)] mt-1">kelas yang diajar</p>
          </CardContent>
        </Card>
        
        <Card className="bg-[hsl(var(--stat-5)/0.1)] border-[hsl(var(--stat-5)/0.3)]">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-[hsl(var(--stat-5))]">Total Generus</CardTitle>
            <GraduationCap className="h-4 w-4 text-[hsl(var(--stat-5))]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[hsl(var(--stat-5))]">{generusData.length}</div>
            <p className="text-xs text-[hsl(var(--stat-5)/0.7)] mt-1">siswa binaan</p>
          </CardContent>
        </Card>
      </div>

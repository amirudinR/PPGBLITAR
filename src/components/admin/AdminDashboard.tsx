      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="bg-card rounded-xl shadow-md">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-blue-500/10 dark:bg-blue-500/200/10 dark:bg-blue-500/10 dark:bg-blue-500/200/20 rounded-lg border border-blue-500/20">
              <div className="flex items-center space-x-3">
                <div className="p-2 bg-blue-500/10 dark:bg-blue-500/200/20 rounded-full">
                  <School className="h-5 w-5 text-blue-500" />
                </div>
                <span className="font-medium text-foreground">Total Kelas</span>
              </div>
              <span className="text-2xl font-bold text-blue-500">{stats.kelas}</span>
            </div>

            <div className="flex items-center justify-between p-4 bg-green-500/10 dark:bg-green-500/200/10 dark:bg-green-500/10 dark:bg-green-500/200/20 rounded-lg border border-green-500/20">
              <div className="flex items-center space-x-3">
                <div className="p-2 bg-green-500/10 dark:bg-green-500/200/20 rounded-full">
                  <BookOpen className="h-5 w-5 text-green-500" />
                </div>
                <span className="font-medium text-foreground">Total Materi</span>
              </div>
              <span className="text-2xl font-bold text-green-500">{materials.length}</span>
            </div>

            <div className="flex items-center justify-between p-4 bg-amber-500/10 dark:bg-amber-500/200/10 dark:bg-amber-500/10 dark:bg-amber-500/200/20 rounded-lg border border-amber-500/20">
              <div className="flex items-center space-x-3">
                <div className="p-2 bg-amber-500/10 dark:bg-amber-500/200/20 rounded-full">
                  <Calendar className="h-5 w-5 text-amber-500" />
                </div>
                <span className="font-medium text-foreground">Kehadiran Rata-rata</span>
              </div>
              <span className="text-2xl font-bold text-amber-500">{overallStats.overallAttendanceRate}%</span>
            </div>
          </CardContent>
        </Card>

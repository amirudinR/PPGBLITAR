...
export default function AdminDashboard({ currentUser, handleLogout }: AdminDashboardProps) {
  ...
  const { generus, loading: loadingGenerus, fetchGenerus, newGenerus, setNewGenerus, addGenerus, updateGenerus, deleteGenerus, addMultipleGenerus } = useGenerus(currentUser);
    ...
    switch (activeSection) {
      ...
      case 'generus':
        return <GenerusSection 
          ...
          onAddMultipleGenerus={addMultipleGenerus}
